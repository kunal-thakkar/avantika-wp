...
class ec_shipping{
	...
	public function get_single_shipping_price_content( $standard_text, $express_text, $standard_price ){
		...
		$ret_string = "";
		$ret_string .= "<div id=\"ec_cart_standard_shipping_row\" class=\"ec_cart_shipping_method_row\"><input type=\"radio\" name=\"ec_cart_shipping_method\" id=\"ec_cart_shipping_method\" value=\"standard\" checked=\"checked\" /><span class=\"ec_cart_standard_shipping_price_label\">" . $standard_text . " (" . $GLOBALS['currency']->get_symbol( ) . "</span><span id=\"ec_cart_standard_shipping_price\">" . $GLOBALS['currency']->get_number_only( $standard_price + $this->handling - $shipping_discount ) . "</span>)</div>";
