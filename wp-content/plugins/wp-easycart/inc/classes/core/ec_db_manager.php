...
CREATE TABLE ec_country (
  ...
  iso2_cnt varchar(255) NOT NULL DEFAULT '',
  iso3_cnt varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE ec_order (
  ...
  giftcard_id varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE ec_state (
  ...
  code_sta varchar(255) NOT NULL DEFAULT '',
	...
	public function install_base_data( ){
		...
		$wpdb->insert( 
			...
			array(
				...
				"password" => "91017d590a69dc49807671a51f10ab7f",
				"first_name" => "Demo",
				"last_name" => "User",
