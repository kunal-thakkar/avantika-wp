...
class ec_orderdetail{
	...
	public function display_download_link( $link_text ){
		if( $this->is_download )
			echo "<a href=\"" . $this->account_page . $this->permalink_divider . "ec_page=order_details&amp;order_id=" . $this->order_id . "&amp;orderdetail_id=" . $this->orderdetail_id . "&amp;download_id=" . $this->download_id . "\" class=\"ec_account_order_item_download_button\" onclick=\"update_download_count( '" . $this->orderdetail_id . "' );\">" . $link_text . "</a>";
	}
