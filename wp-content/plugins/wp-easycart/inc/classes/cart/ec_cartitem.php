...
class ec_cartitem{
	...
	function __construct( $cartitem_data ){
		...
		if( $cartitem_data->optionitem_id_1 ){
			...
			$this->optionitem1_name = $this->optionitem1_label = ""; $this->optionitem1_price = 0.00; $this->optionitem1_id = 0;
		}
		...
		if($cartitem_data->optionitem_id_2 ){
			...
			$this->optionitem2_name = $this->optionitem2_label = ""; $this->optionitem2_price = 0.00; $this->optionitem2_id = 0;
		}
		...
		if($cartitem_data->optionitem_id_3 ){
			...
			$this->optionitem3_name = $this->optionitem3_label = ""; $this->optionitem3_price = 0.00; $this->optionitem3_id = 0;
		}
		...
		if($cartitem_data->optionitem_id_4 ){
			...
			$this->optionitem4_name = $this->optionitem4_label = ""; $this->optionitem4_price = 0.00; $this->optionitem4_id = 0;
		}
		...
		if($cartitem_data->optionitem_id_5 ){
			...
			$this->optionitem5_name = $this->optionitem5_label = ""; $this->optionitem5_price = 0.00; $this->optionitem5_id = 0;
		}
