...
class ec_admin_orders{		
	...
	function getorderdetailsadvancedoptions( $orderdetails_id ){
		...
		$sql = "SELECT ec_order_option.* FROM ec_order_option WHERE ec_order_option.orderdetail_id = %s ORDER BY ec_order_option.option_order ASC, ec_order_option.option_to_product_id ASC, ec_order_option.order_option_id ASC";
	...
	function updateorderstatus( $orderid, $status ){
		...
		$order = $this->db->get_row( $this->db->prepare( "SELECT ec_order.*, ec_orderstatus.is_approved FROM ec_order LEFT JOIN ec_orderstatus ON ec_orderstatus.order_status = ec_order.orderstatus_id WHERE ec_order.order_id = %d", $orderid ) );
