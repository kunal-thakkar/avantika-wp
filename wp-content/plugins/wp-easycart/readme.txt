...
WordPress eCommerce Shopping Cart plugin that can sell products, downloads, anything online with only a few clicks!

== Description ==

The WordPress eCommerce plugin by WP EasyCart is a simple shopping cart plugin that installs into new or existing WordPress blogs and websites. 
...
The WordPress eCommerce plugin will work in nearly every theme.  The entire ecommerce shopping cart is a matter of setting up 3 pages for the store, cart/checkout, and customer account areas.  Within 5 minutes the shopping cart plugin can be installed and running.  
...
= CUSTOM DEVELOPMENT = 
Don't see what you are looking for?  Perhaps you want a custom design WordPress eCommerce shopping cart or integration into your existing site and need professional EasyCart developers or designers to get you quickly up and running?

WP EasyCart is a full service agency and offers custom services such as WordPress design, WordPress cart development, WordPress ecommerce, WordPress shopping cart payment gateway integration, you name it.  Even if you have a small need such as a custom button somewhere, let our team help get your WordPress ecommerce shopping cart package right for you.  For more information, please visit the [WP EasyCart website]( http://www.wpeasycart.com "WP EasyCart Shopping Cart Plugin") for more information.
...
**For more information on upgrading, please visit our website at [WP EasyCart Upgrading Process](http://v3docs.wpeasycart.com/3.0.0/index/upgrading.php "WP EasyCart Upgrading Process")
...
FREE version comes from wordpress and offers limited features for you to test.  Manual payments is accepted, but coupons, live shipping rates, promotions are not included.  Lite version jumps up to 3rd party processing (paypal standard).  The Full version jumps up to coupons, promotions, live shipping, and full payment gateways.

= How does a license work with your software? =
The free plugin is the full WordPress ecommerce shopping cart software version; however, the administrative software that is downloaded from our website is licensed software. The administrative software will allow a certain number of products and features to be used in the cart software. You may continue to run the WordPress plugin, but must purchase a license to use our administrative software.
...
Yes!  EasyCart works on 3 wordpress pages, simply create a store, cart, and account page and attach our shortcode on each one.  Our installer walks you through the steps quickly and if you have any theme issues, your theme developer or our staff can assist.

= What payment gateways do you have? =
We offer over 30 different gateways.  Popular ones include PayPal Standard, PayPal Pro, PayPal Payflow, authorize.net, stripe.com, firstdata, eway, payment express, sagepay, and many others.  Check our documentation for a full up to date listing.
...
* Fix - Authorize.net needed to accept response code 4 as a successful purchase as funds are available once accepted and is almost identical to a successful transaction response.
= 3.2.19 =
