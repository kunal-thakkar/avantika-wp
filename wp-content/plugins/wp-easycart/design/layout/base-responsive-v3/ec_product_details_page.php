...
?>
<?php if( $show_video ){ ?>
<div class="ec_admin_video_container" id="ec_admin_video_container">
		...
		<div class="ec_admin_video_padding">
    		<div class="ec_admin_video_holder">
    	    	<div class="ec_admin_video">
    	        	...
    	        	<div class="ec_admin_video_close"><a href="<?php echo $this->storepage . $this->permalink_divider . "ec_admin_action=hide-video"; ?>" onclick="ec_admin_close_video_screen( ); return false;">x</a></div>
                </div>
    	    </div>
    	</div>
	</div>
...
<div itemscope itemtype="http://schema.org/Product" style="display:none;">
    ...
    <span itemprop="image" src="<?php echo $this->product->get_first_image_url( ); ?>" alt="<?php echo $this->product->title; ?>"></span>
...
<section class="ec_product_details_page"><?php if( $this->product->has_promotion_text( ) ){ ?>
    ...
    <div class="ec_details_content">
        ...
        <div class="ec_details_images">
        	<div class="ec_details_main_image ec_details_main_image_<?php echo $this->product->product_id; ?>"<?php if( get_option( 'ec_option_show_large_popup' ) ){?> onclick="ec_details_show_image_popup( '<?php echo $this->product->model_number; ?>' );"<?php }else{ ?> style="cursor:inherit;"<?php }?>><img src="<?php echo $this->product->get_first_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div>
			...
			if( $this->product->use_optionitem_images ){ ?>
				...
				for( $i=0; $i<count( $this->product->images->imageset ); $i++ ){
                    ...
                    <div class="ec_details_thumbnails ec_details_thumbnails_<?php echo $this->product->product_id; ?><?php if( $thumbnails_displayed > 0 ){ ?> ec_inactive<?php }?><?php if( $this->product->images->imageset[$i]->image2 == "" ){ ?> ec_no_thumbnails<?php }?>" id="ec_details_thumbnails_<?php echo $this->product->images->imageset[$i]->optionitem_id; ?>_<?php echo $this->product->product_id; ?>"<?php if( trim( $this->product->images->imageset[$i]->image2 ) == "" ){ ?> style="display:none !important;"<?php }?>>
                        <div class="ec_details_thumbnail ec_details_thumbnail_<?php echo $this->product->product_id; ?> ec_active"><img src="<?php echo plugins_url( "/wp-easycart-data/products/pics1/" . $this->product->images->imageset[$i]->image1 ); ?>" alt="<?php echo $this->product->title; ?>" /></div>
                        <?php if( trim( $this->product->images->imageset[$i]->image2 ) != "" ){ ?><div class="ec_details_thumbnail ec_details_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo plugins_url( "/wp-easycart-data/products/pics2/" . $this->product->images->imageset[$i]->image2 ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
                        <?php if( trim( $this->product->images->imageset[$i]->image3 ) != "" ){ ?><div class="ec_details_thumbnail ec_details_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo plugins_url( "/wp-easycart-data/products/pics3/" . $this->product->images->imageset[$i]->image3 ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
                        <?php if( trim( $this->product->images->imageset[$i]->image4 ) != "" ){ ?><div class="ec_details_thumbnail ec_details_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo plugins_url( "/wp-easycart-data/products/pics4/" . $this->product->images->imageset[$i]->image4 ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
                        <?php if( trim( $this->product->images->imageset[$i]->image5 ) != "" ){ ?><div class="ec_details_thumbnail ec_details_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo plugins_url( "/wp-easycart-data/products/pics5/" . $this->product->images->imageset[$i]->image5 ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
                    </div>
                    <?php
            ...
            <div class="ec_details_thumbnails ec_details_thumbnails_<?php echo $this->product->product_id; ?>">
            	<div class="ec_details_thumbnail ec_details_thumbnail_<?php echo $this->product->product_id; ?> ec_active"><img src="<?php echo $this->product->get_first_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div>
            	<div class="ec_details_thumbnail ec_details_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo $this->product->get_second_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div>
            	<?php if( trim( $this->product->images->image3 ) != "" ){ ?><div class="ec_details_thumbnail ec_details_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo $this->product->get_third_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
            	<?php if( trim( $this->product->images->image4 ) != "" ){ ?><div class="ec_details_thumbnail ec_details_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo $this->product->get_fourth_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
            	<?php if( trim( $this->product->images->image5 ) != "" ){ ?><div class="ec_details_thumbnail ec_details_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo $this->product->get_fifth_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
            </div>
            <?php }?>
            	...
            	<div class="ec_details_large_popup_content">
                	<div class="ec_details_large_popup_padding">
                    	<div class="ec_details_large_popup_holder">
                            <div class="ec_details_large_popup_main ec_details_large_popup_main_<?php echo $this->product->product_id; ?>"><img src="<?php echo $this->product->get_first_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div>
                            ...
                            <?php if( $this->product->use_optionitem_images ){ ?>
                                ...
                                for( $i=0; $i<count( $this->product->images->imageset ); $i++ ){
                                    ...
                                    <div class="ec_details_large_popup_thumbnails ec_details_large_popup_thumbnails_<?php echo $this->product->product_id; ?><?php if( $i > 0 ){ ?> ec_inactive<?php }?>" id="ec_details_large_popup_thumbnails_<?php echo $this->product->images->imageset[$i]->optionitem_id; ?>_<?php echo $this->product->product_id; ?>"<?php if( trim( $this->product->images->imageset[$i]->image2 ) == "" ){ ?> style="display:none;"<?php }?>>
                                        <div class="ec_details_large_popup_thumbnail ec_details_large_popup_thumbnail_<?php echo $this->product->product_id; ?> ec_active"><img src="<?php echo plugins_url( "/wp-easycart-data/products/pics1/" . $this->product->images->imageset[$i]->image1 ); ?>" alt="<?php echo $this->product->title; ?>" /></div>
                                        <?php if( trim( $this->product->images->imageset[$i]->image2 ) != "" ){ ?><div class="ec_details_large_popup_thumbnail ec_details_large_popup_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo plugins_url( "/wp-easycart-data/products/pics2/" . $this->product->images->imageset[$i]->image2 ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
                                        <?php if( trim( $this->product->images->imageset[$i]->image3 ) != "" ){ ?><div class="ec_details_large_popup_thumbnail ec_details_large_popup_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo plugins_url( "/wp-easycart-data/products/pics3/" . $this->product->images->imageset[$i]->image3 ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
                                        <?php if( trim( $this->product->images->imageset[$i]->image4 ) != "" ){ ?><div class="ec_details_large_popup_thumbnail ec_details_large_popup_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo plugins_url( "/wp-easycart-data/products/pics4/" . $this->product->images->imageset[$i]->image4 ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
                                        <?php if( trim( $this->product->images->imageset[$i]->image5 ) != "" ){ ?><div class="ec_details_large_popup_thumbnail ec_details_large_popup_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo plugins_url( "/wp-easycart-data/products/pics5/" . $this->product->images->imageset[$i]->image5 ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
                                    </div>
                                    <?php
                                }
                                ?>
                            ...
                            <div class="ec_details_large_popup_thumbnails ec_details_large_popup_thumbnails_<?php echo $this->product->product_id; ?>">
                                <div class="ec_details_large_popup_thumbnail ec_details_large_popup_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo $this->product->get_first_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div>
                                <div class="ec_details_large_popup_thumbnail ec_details_large_popup_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo $this->product->get_second_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div>
                                <?php if( trim( $this->product->images->image3 ) != "" ){ ?><div class="ec_details_large_popup_thumbnail ec_details_large_popup_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo $this->product->get_third_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
                                <?php if( trim( $this->product->images->image4 ) != "" ){ ?><div class="ec_details_large_popup_thumbnail ec_details_large_popup_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo $this->product->get_fourth_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
                                <?php if( trim( $this->product->images->image5 ) != "" ){ ?><div class="ec_details_large_popup_thumbnail ec_details_large_popup_thumbnail_<?php echo $this->product->product_id; ?>"><img src="<?php echo $this->product->get_fifth_image_url( ); ?>" alt="<?php echo $this->product->title; ?>" /></div><?php } ?>
                            </div>
                            <?php }?>
        ...
        <div class="ec_details_right">
			...
			for( $i=0; $i<5; $i++ ){ ?>
                ...
                <div class="ec_details_option_row">
					...
					for( $j=0; $j<count( $optionsets[$i]->optionset ); $j++ ){
						...
						if( $this->product->use_optionitem_quantity_tracking && ( $i > 0 || $this->product->option1quantity[$optionsets[$i]->optionset[$j]->optionitem_id] <= 0 ) ){
                ...
                <div class="ec_details_option_row">
					...
					?>
                    <?php if( !$this->product->use_optionitem_quantity_tracking || $i != 0 || $this->product->option1quantity[$optionsets[$i]->optionset[$j]->optionitem_id] > 0 ){ ?> 
                ...
                <div class="ec_details_option_row ec_option_type_<?php echo $optionset->option_type; ?>" data-option-id="<?php echo $optionset->option_id; ?>" data-option-required="<?php echo $optionset->option_required; ?>" data-product-id="<?php echo $this->product->product_id; ?>">
					...
					?>
                    	...
                    	<ul class="ec_details_swatches">
                            ...
                            ?>
                            	<li class="ec_details_swatch ec_advanced ec_option_<?php echo $optionset->option_id; ?>_<?php echo $this->product->product_id; ?> ec_active<?php if( $optionsets[$i]->optionset[$j]->optionitem_initially_selected ){ ?> ec_selected<?php }?>" data-product-id="<?php echo $this->product->product_id; ?>" data-optionitem-id="<?php echo $optionitems[$j]->optionitem_id; ?>" data-option-id="<?php echo $optionset->option_id; ?>" data-optionitem-price="<?php echo $optionitems[$j]->optionitem_price; ?>" data-optionitem-price-onetime="<?php echo $optionitems[$j]->optionitem_price_onetime; ?>" data-optionitem-price-override="<?php echo $optionitems[$j]->optionitem_price_override; ?>" data-optionitem-price-multiplier="<?php echo $optionitems[$j]->optionitem_price_multiplier; ?>"><img src="<?php echo plugins_url( "/wp-easycart-data/products/swatches/" . $optionitems[$j]->optionitem_icon ); ?>"<?php if( $optionitems[$j]->optionitem_price > 0 ){ ?> title="<?php echo str_replace( '"', '&quot;', $optionitems[$j]->optionitem_name ); ?> +<?php echo $GLOBALS['currency']->get_currency_display( $optionitems[$j]->optionitem_price ); ?> <?php echo $GLOBALS['language']->get_text( 'cart', 'cart_item_adjustment' ); ?>"<?php }else if( $optionitems[$j]->optionitem_price < 0 ){ ?> title="<?php echo str_replace( '"', '&quot;', $optionitems[$j]->optionitem_name ); ?> <?php echo $GLOBALS['currency']->get_currency_display( $optionitems[$j]->optionitem_price ); ?> <?php echo $GLOBALS['language']->get_text( 'cart', 'cart_item_adjustment' ); ?>"<?php }else if( $optionitems[$j]->optionitem_price_onetime > 0 ){ ?> title="<?php echo str_replace( '"', '&quot;', $optionitems[$j]->optionitem_name ); ?> +<?php echo $GLOBALS['currency']->get_currency_display( $optionitems[$j]->optionitem_price_onetime ); ?> <?php echo $GLOBALS['language']->get_text( 'cart', 'cart_order_adjustment' ); ?>"<?php }else if( $optionitems[$j]->optionitem_price_onetime < 0 ){ ?> title="<?php echo str_replace( '"', '&quot;', $optionitems[$j]->optionitem_name ); ?> <?php echo $GLOBALS['currency']->get_currency_display( $optionitems[$j]->optionitem_price_onetime ); ?> <?php echo $GLOBALS['language']->get_text( 'cart', 'cart_order_adjustment' ); ?>"<?php }else if( isset( $optionitems[$j]->optionitem_price_override ) && $optionitems[$j]->optionitem_price_override > -1 ){ ?> title="<?php echo str_replace( '"', '&quot;', $optionitems[$j]->optionitem_name ); ?> <?php $GLOBALS['language']->get_text( 'cart', 'cart_item_new_price_option' ); ?> <?php echo $GLOBALS['currency']->get_currency_display( $optionitems[$j]->optionitem_price_override ); ?>"<?php }else{ ?> title="<?php echo str_replace( '"', '&quot;', $optionitems[$j]->optionitem_name ); ?>"<?php }?>/></li>
                            <?php
							}
							?>
                        </ul>
					...
					?>
                    	...
                    	<input type="number" name="ec_option_<?php echo $optionset->option_id; ?>" id="ec_option_<?php echo $optionset->option_id; ?>_<?php echo $this->product->product_id; ?>" data-product-id="<?php echo $this->product->product_id; ?>" data-optionitem-price="<?php echo $optionitems[0]->optionitem_price; ?>" data-optionitem-price-onetime="<?php echo $optionitems[0]->optionitem_price_onetime; ?>" data-optionitem-price-override="<?php echo $optionitems[0]->optionitem_price_override; ?>" data-optionitem-price-multiplier="<?php echo $optionitems[0]->optionitem_price_multiplier; ?>" value="<?php echo $optionitems[0]->optionitem_initial_value; ?>" /><?php if( $optionitems[0]->optionitem_price > 0 ){ echo ' (+' . $GLOBALS['currency']->get_currency_display( $optionitems[0]->optionitem_price ) . ' ' . $GLOBALS['language']->get_text( 'cart', 'cart_item_adjustment' ) . ')'; }else if( $optionitems[0]->optionitem_price < 0 ){ echo ' (' . $GLOBALS['currency']->get_currency_display( $optionitems[0]->optionitem_price ) . ' ' . $GLOBALS['language']->get_text( 'cart', 'cart_item_adjustment' ) . ')'; }else if( $optionitems[0]->optionitem_price_onetime > 0 ){ echo ' (+' . $GLOBALS['currency']->get_currency_display( $optionitems[0]->optionitem_price_onetime ) . ' ' . $GLOBALS['language']->get_text( 'cart', 'cart_order_adjustment' ) . ')'; }else if( $optionitems[0]->optionitem_price_onetime < 0 ){ echo ' (' . $GLOBALS['currency']->get_currency_display( $optionitems[0]->optionitem_price_onetime ) . ' ' . $GLOBALS['language']->get_text( 'cart', 'cart_order_adjustment' ) . ')'; }else if( isset( $optionitems[0]->optionitem_price_override ) && $optionitems[0]->optionitem_price_override > -1 ){ echo ' (' . $GLOBALS['language']->get_text( 'cart', 'cart_item_new_price_option' ) . ' ' . $GLOBALS['currency']->get_currency_display( $optionitems[0]->optionitem_price_override ) . ')'; }else if( isset( $optionitems[0]->optionitem_price_per_character ) && $optionitems[0]->optionitem_price_per_character > 0 ){ echo ' (' . $GLOBALS['language']->get_text( 'cart', 'cart_item_adjustment' ) . ' ' . $GLOBALS['currency']->get_currency_display( $optionitems[0]->optionitem_price_per_character ) . ' ' . $GLOBALS['language']->get_text( 'cart', 'cart_item_adjustment_per_character' ) . ')'; } ?>
            ...
            <div class="ec_details_add_to_cart_area">
                ...
                <div class="ec_details_add_to_cart">
                    ...
                    <input type="submit" value="<?php echo $GLOBALS['language']->get_text( 'product_details', 'product_details_inquire' ); ?>" <?php if( $this->product->inquiry_url == "" ){ ?>onclick="return ec_details_show_inquiry_form( '<?php echo $this->product->product_id; ?>' );" <?php }?>style="margin-left:0px !important;" />
                	<?php }else{ ?>
                ...
                <div class="ec_details_add_to_cart ec_deconetwork_custom_space">
                    <input type="submit" value="<?php echo $GLOBALS['language']->get_text( 'product_details', 'product_details_add_to_cart' ); ?>" onclick="return ec_details_add_to_cart_<?php echo $this->product->product_id; ?>( );"<?php if( $has_quantity_grid ){ ?> style="margin-left:0px !important;"<?php }?> />
                </div>
                ...
                <div class="ec_details_add_to_cart">
                	<input type="submit" value="<?php echo $GLOBALS['language']->get_text( 'product_details', 'product_details_sign_up_now' ); ?>" onclick="return ec_details_add_to_cart_<?php echo $this->product->product_id; ?>( );"<?php if( get_option( 'ec_option_subscription_one_only' ) ){ ?> style="margin-left:0px !important;"<?php }?> />
                </div>
				...
				<div class="ec_details_quantity"<?php if( $has_quantity_grid ){ ?> style="display:none;"<?php }?>><input type="button" value="-" class="ec_minus" onclick="ec_minus_quantity( '<?php echo $this->product->product_id; ?>', <?php echo $this->product->min_purchase_quantity; ?> );" /><input type="number" value="<?php if( $this->product->min_purchase_quantity > 0 ){ echo $this->product->min_purchase_quantity; }else{ echo '1'; } ?>" name="ec_quantity" id="ec_quantity_<?php echo $this->product->product_id; ?>" autocomplete="off" step="1" min="<?php if( $this->product->min_purchase_quantity > 0 ){ echo $this->product->min_purchase_quantity; }else{ echo '1'; } ?>" class="ec_quantity"<?php if( $this->product->max_purchase_quantity > 0 ){ ?> max="<?php echo $this->product->max_purchase_quantity; ?>"<?php }?> /><input type="button" value="+" class="ec_plus" onclick="ec_plus_quantity( '<?php echo $this->product->product_id; ?>', <?php echo $this->product->show_stock_quantity; ?>, <?php if( $this->product->max_purchase_quantity > 0 ){ echo $this->product->max_purchase_quantity; }else{ echo 100000000; } ?> );" /></div>
                <div class="ec_details_add_to_cart">
                	<input type="submit" value="<?php echo $GLOBALS['language']->get_text( 'product_details', 'product_details_backorder_button' ); ?>" onclick="return ec_details_add_to_cart_<?php echo $this->product->product_id; ?>( );"<?php if( $has_quantity_grid ){ ?> style="margin-left:0px !important;"<?php }?> />
                </div>
            ...
            <?php if( !$this->product->in_stock( ) && $this->product->allow_backorders ){ ?>
...
function ec_details_advanced_adjust_price_<?php echo $this->product->product_id; ?>( ){	
	...
	var new_price = ( base_price + Number( checkbox_adj ) + Number( combo_adj ) + Number( date_adj ) + Number( file_adj ) + Number( swatch_adj ) + Number( grid_adj ) + Number( radio_adj ) + Number( text_adj ) + Number( number_adj ) + Number( textarea_adj ) );
	var new_price_sqft = new_price * sq_footage;
	var override_price_final = override_price + Number( checkbox_adj ) + Number( combo_adj ) + Number( date_adj ) + Number( file_adj ) + Number( swatch_adj ) + Number( grid_adj ) + Number( radio_adj ) + Number( text_adj ) + Number( number_adj ) + Number( textarea_adj );
