    ...
    <div class="ec_account_left">
	  ...
	  <div class="ec_cart_input_row">
        ...
        <div class="ec_cart_button_row">
        	<input type="submit" value="<?php echo $GLOBALS['language']->get_text( 'account_password', 'account_password_update_button' ); ?>" class="ec_account_button" onclick="return ec_account_password_button_click( );" />
