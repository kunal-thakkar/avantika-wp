                ...
                <div class="ec_product_quickview_content_data">
                    ...
                    <div class="ec_product_quickview_content_add_to_cart_container">
                        ...
                        <table class="ec_product_quickview_content_quantity">
                            ...
                            <tr>
                            	<td colspan="3">
                                	<input type="button" value="BACKORDER" onclick="ec_add_to_cart( '<?php echo $product->product_id; ?>', '<?php echo $product->model_number; ?>', jQuery( document.getElementById( 'ec_quantity_<?php echo $product->model_number; ?>' ) ).val( ), <?php echo $product->show_stock_quantity; ?>, <?php echo $product->min_purchase_quantity; ?>, <?php if( $product->max_purchase_quantity > 0 ){ echo $product->max_purchase_quantity; }else{ echo $product->stock_quantity; } ?> );" />
...
<a href="http://v3docs.wpeasycart.com/3.0.0/index/known_issues.php?jqueryissue=true" target="_blank" id="ec_product_editor_openclose_button_<?php echo $product->model_number; ?>" class="ec_product_openclose" onclick="ec_product_editor_openclose( '<?php echo $product->model_number; ?>' ); return false;"><div class="dashicons dashicons-admin-generic"></div></a>
...
<?php }?>
	...
	<div style="padding:0px; margin:auto; vertical-align:middle;<?php if( $product_type == 0 ){ ?> display:none;<?php }?>" class="ec_product_type<?php echo $product_type; ?>" id="ec_product_image_<?php echo $product->model_number; ?>">
        ...
        <div class="ec_product_meta_type6">
            ...
            <div class="ec_product_addtocart_container">
            	<span class="ec_product_addtocart">
                	<a id="ec_add_to_cart_type6_<?php echo $product->product_id; ?>" href="<?php echo $product->get_add_to_cart_link( ); ?>" onclick="ec_add_to_cart( '<?php echo $product->product_id; ?>', '<?php echo $product->model_number; ?>', 1 ); return false;"><?php echo $GLOBALS['language']->get_text( 'product_details', 'product_details_add_to_cart' ); ?></a>
			...
			<div class="ec_product_addtocart_container">
            	<span class="ec_product_addtocart">
                	<a id="ec_add_to_cart_type6_<?php echo $product->product_id; ?>" href="<?php echo $product->get_add_to_cart_link( ); ?>" onclick="ec_add_to_cart( '<?php echo $product->product_id; ?>', '<?php echo $product->model_number; ?>', 1 ); return false;"><?php echo $GLOBALS['language']->get_text( 'product_details', 'product_details_backorder_button' ); ?></a>
            		<a id="ec_added_to_cart_type6_<?php echo $product->product_id; ?>" href="<?php echo $product->cart_page; ?>" class="ec_added_to_cart_button"><?php echo $GLOBALS['language']->get_text( 'product_details', 'product_details_added_to_cart' ); ?></a>
                </span>
            </div>
        ...
        <div class="ec_product_addtocart_container">
        	<span class="ec_product_addtocart">
                <a id="ec_add_to_cart_<?php echo $product->product_id; ?>" href="<?php echo $product->get_add_to_cart_link( ); ?>" onclick="ec_add_to_cart( '<?php echo $product->product_id; ?>', '<?php echo $product->model_number; ?>', 1 ); return false;"><?php echo $GLOBALS['language']->get_text( 'product_details', 'product_details_add_to_cart' ); ?></a>
        ...
        <div class="ec_product_addtocart_container">
        	<span class="ec_product_addtocart">
            	<a id="ec_add_to_cart_<?php echo $product->product_id; ?>" href="<?php echo $product->get_add_to_cart_link( ); ?>" onclick="ec_add_to_cart( '<?php echo $product->product_id; ?>', '<?php echo $product->model_number; ?>', 1 ); return false;"><?php echo $GLOBALS['language']->get_text( 'product_details', 'product_details_backorder_button' ); ?></a>
            	<a id="ec_added_to_cart_<?php echo $product->product_id; ?>" href="<?php echo $product->cart_page; ?>" class="ec_added_to_cart_button"><?php echo $GLOBALS['language']->get_text( 'product_details', 'product_details_added_to_cart' ); ?></a>
            </span>
        </div>
        <?php }?>
