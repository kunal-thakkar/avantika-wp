...
<div class="ec_cart_left">
    ...
    <div class="ec_cart_button_row">
		...
		<?php }?>
		<input type="submit" value="<?php echo $GLOBALS['language']->get_text( 'account_register', 'account_register_button' ); ?>" class="ec_account_button" onclick="return ec_account_register_button_click2( );" />
    </div>
