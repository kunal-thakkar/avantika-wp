                    ...
                    <select id="property_<?php echo $att->attribute_id; ?>" name='property[<?php echo $att->attribute_id; ?>]' class='property' >
                        ...
                        if (!empty($att->properties)) {
                            foreach ((array) $att->properties as $prop) {
                                ?>
                                <option <?php echo (in_array($prop->property_id, (array) $this->variations_assoc) ? 'selected="selected"' : ''); ?> value='<?php echo $prop->property_id; ?>'><?php echo strings::htmlentities($prop->property_name); ?></option>
                            <?php } ?>
                        </select>
                    <?php } ?>
                </li>
