    ...
    function igthemes_credit() { ?>
        <div class="site-info">
            ...
            <?php if ( apply_filters( 'igthemes_credit_link', true ) ) { ?>
                <br /><?php printf( esc_attr__( '%1$s designed by %2$s.', 'basic-shop' ), 'Basic Shop', '<a href="http://www.iograficathemes.com" alt="Free and Premium WordPress Themes & Plugins" title="Free and Premium WordPress Themes & Plugins" rel="designer">Iografica Themes</a>' ); ?>
            <?php } ?>
        </div><!-- .site-info -->
    <?php }
}
